...
/*  The following constructor added by P. Mohan on February 8, 2019 */
    ...
    */
	...
	String filename = "C:\\Users\\Rasa\\Desktop\\Game Programming\\2019-03-19\\SideScroller-Brackeen\\images\\" + name;
...
System.out.println("Image file opened: " + filename);
    ...
    public TileMap loadNextMap() {
        ...
        while (map == null) {
            currentMap++;
   	    String mapFile = "C:\\Users\\Rasa\\Desktop\\Game Programming\\2019-03-19\\SideScroller-Brackeen\\maps\\map" + currentMap + ".txt";
            try {		
		map = loadMap(mapFile);
/*
                map = loadMap(
...
*/
    ...
    public TileMap reloadMap() {
        try {
            return loadMap(
                "C:\\Users\\Rasa\\Desktop\\Game Programming\\2019-03-19\\SideScroller-Brackeen\\maps\\map" + currentMap + ".txt");
        }
        catch (IOException ex) {
            ex.printStackTrace();
            return null;
    ...
    public void loadTileImages() {
        ...
        while (true) {
            ...
            File file = new File("C:\\Users\\Rasa\\Desktop\\Game Programming\\2019-03-19\\SideScroller-Brackeen\\images\\" + name);
            if (!file.exists()) {
